...
## DCGAN
  ...
  The Generator Network consists of Batch Normalized Transpose Covolutional with ReLu activation for hidden layers and TanH as the activation function for the last layer. And it also uses strides 2, but this time for upsampling the initial image.
